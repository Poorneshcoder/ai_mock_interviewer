...
const RecordAnswer = ({mockInterviewQuestion, activeQuestionIndex, interviewData}) => {
    ...
    return(
        <div className="flex items-center justify-center flex-col">
            ...
            <Button disabled={loading} onClick={StartStopRecording} variant="outline" className='my-10'>{isRecording?
                <h2 className="text-red-600 flex gap-2"><Mic/> Stop Recording</h2> : 'Record Answer'    
                }
            </Button>
        </div>
    )
